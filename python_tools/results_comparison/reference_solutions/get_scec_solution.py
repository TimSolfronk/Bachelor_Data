...
parser = argparse.ArgumentParser(description='Script to scrape reference solutions from the SCEC/USGS Spontaneous Rupture Code Verification Project site ')
parser.add_argument("--s",               dest="scenario",      type=str,   required=True,  help="Name of the scenario you want to get a solution for." )
parser.add_argument("--r",               dest="reference",      type=str,   required=True,  help="Name of the reference solution you want to get, e.g. 'barall'" )
args = parser.parse_args()
scenario_name = args.scenario
reference_name = args.reference

# prefixes of the important html objects
PUB_AREA_CODE = "G0012"
SCENARIOS_CODE = "G1045"
SOLUTIONS_CODE = "G1047"
RAW_DATA_CODE = "G1059"

# all tracer types that can be scraped
