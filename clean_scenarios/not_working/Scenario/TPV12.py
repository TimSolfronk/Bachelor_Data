...
class TPV12(Scenario):
    ...
    Spontaneous rupture on a 60 degree dipping dip-slip fault (normal fault) in a homogeneous halfspace. 
    Material properties are linear elastic. Initial stress conditions are dependent on depth. Strongly supershear rupture conditions. 

    The description of the scenario can be found at: https://strike.scec.org/cvws/tpv12_13docs.html
    """
