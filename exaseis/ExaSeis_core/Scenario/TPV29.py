...
class TPV29(Scenario):
    ...
    tracer_coordinates = [
          ...
          [19.8,  1.4,  9.0],
          [19.8, 10.1, 11.1],
          [19.8,  0.0, 15.0], #surface above fault hypocenter
          [19.8, 10.0, 15.0], #on fault hypocenter
          [19.8, 16.0, 15.0],
          [19.8,  6.1, 15.8],
          [19.8, 12.0, 20.0],
          [19.8,  6.2, 15.7],
          ...
          [20.2,  1.4,  9.0],
          [20.2, 10.1, 11.1],
          [20.2,  0.0, 15.0], #surface above fault hypocenter
          [20.2, 10.0, 15.0], #on fault hypocenter
          [20.2, 16.0, 15.0],
          [20.2,  6.1, 15.8],
          [20.2, 12.0, 20.0],
          [20.2,  6.2, 15.7],
