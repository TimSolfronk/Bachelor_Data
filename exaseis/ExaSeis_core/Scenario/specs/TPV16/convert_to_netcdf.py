...
sig_n = 5-1; sig_h_shear = 6-1; sig_v_shear = 7-1; mu_s = 10-1; mu_d = 11-1; d_c = 12-1; cohesion = 13-1; time_forced_rup = 14-1 # python begin from 0!
...
#s_xx, s_xz, s_xy, mu_s, mu_d, d_c, cohesion, forced_rupture_time
...
nc.close()
print('Done')
with xr.open_dataset('../TPV29/tpv29_buffer_n.nc') as ds:
    print(ds)
    print()
with xr.open_dataset('../TPV16/tpv16_fault.nc') as ds:
    print(ds)