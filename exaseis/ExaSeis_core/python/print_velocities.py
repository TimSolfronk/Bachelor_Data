...
axs[0].set(xlabel="t", ylabel="vx")
axs[0].grid()

axs[1].plot(
  dt, vy, lw=4
)
axs[1].set(xlabel="t", ylabel="vy")
axs[1].grid()
...
if dim==3:
  ...
  axs[2].set(xlabel="t", ylabel="vz")
  axs[2].grid()

fig.suptitle("velocities as a function of time", fontsize=20)
plt.legend()
plt.show()
