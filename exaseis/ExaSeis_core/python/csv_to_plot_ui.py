...
if __name__ == "__main__":
    ...
    parser.add_argument("--v",               dest="v",              type=str,   default="2,3,7,8,11,12",     help="A comma seperated öist of the variables to be plotted (e.g. --v '1-4,8' to plot the first 4 and the 8th )" )
